 ...
 * Scrum
 * 
 * Extend the metaphor of scrum to show value in the back lines
 * 
 * A customer only exposition of value 
 * Value is shown as the back lines
 * 
 * Show the 
 */
...
function draw() {
    ...
    line(x5, 62, this.box_strat.box_x1-10, 62);
    ...
    line(x5, 100, this.box_ops.box_x1-10, 100);
    ...
    line(x5, 142, this.box_team.box_x1-10, 142);
    ...
    line(x5, 182, this.box_person.box_x1-10, 182);
